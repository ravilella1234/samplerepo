...
public class CustomerRegistrationPage 
{
	...
	public void customerRegistration() throws InterruptedException
	{
		...
		waitforElement(custEmail,30,"visibilityOf");
		custEmail.sendKeys("qatest945849@gmail.com");
		System.out.println(randNumber());
		
		
		Submit.click();
		
		waitforElement(Title_gen1, 30, "elementToBeClickable");
		Title_gen1.click();
		...
		selectOption(DOB_month,7);
		selectOption(DOB_year,4);
	...
	public void waitforElement(WebElement locator, int timeInSeconds, String verifyType) 
	{
		WebDriverWait wait = new WebDriverWait(driver, timeInSeconds);
		if(verifyType.equals("visibilityOf")) {
			wait.until(ExpectedConditions.visibilityOf(locator));
		}else if(verifyType.equals("elementToBeClickable")) {
